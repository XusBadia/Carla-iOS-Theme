...
document.getElementById("lowtemp").innerHTML = lowtext + obj.low[0]  + "\&#176";
document.getElementById("hightemp").innerHTML = hightext + obj.high[0] + "\&#176";
document.getElementById("Day0Icon").src = "Icon Sets/Icons" + "/"+AdjustIcon(obj.icon, where)+".png";
document.getElementById("Day0IconFull").src = "Icon Sets/FullScreen" + "/"+AdjustIcon(obj.icon, where)+".png";
