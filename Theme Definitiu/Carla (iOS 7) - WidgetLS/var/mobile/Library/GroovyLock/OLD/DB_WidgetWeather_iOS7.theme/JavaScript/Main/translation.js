// Translation file based on uniaw 6.3, with credit to Dacal 
...
switch (lang) {
	...
	case "fr":
		...
		var WeatherDesc = [
			...
			"Orages Violents",
			"Orages",
			"Pluie et Neige M̩l̩es",
			"Pluie et Gr̻le M̩l̩es",
			"Neige et Gr̻le M̩l̩es",
			"Bruine Vergla̤ante",
			"Bruine",
			"Pluie Vergla̤ante",
			"Averses",
...
// Moon phase description not used. The moon in animation is set to show current moon phase image
