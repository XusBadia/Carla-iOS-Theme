...
function createACloud() {
    ...
    image.src = "Images/Weather/partlycloudy/" + where + "/cloud" + randomInteger(1, NUMBER_OF_CLOUDS_IMAGES) + ".png";
    ...
    var fadeAndfloatDuration = durationValue(randomFloat(40, 150));
