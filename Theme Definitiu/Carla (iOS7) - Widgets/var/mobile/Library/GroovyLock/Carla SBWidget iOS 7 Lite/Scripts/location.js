...
var effectiveRoot = findChild(findChild(request.responseXML, "query"), "results");
postal = findChild(effectiveRoot, "Result").getElementsByTagName("woeid")[0].childNodes[0].nodeValue;
